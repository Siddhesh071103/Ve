...
const Login = ({navigation}) => {
  ...
  return (
    <ImageBackground source={image} resizeMode="cover" style={styles.bg}>
          <TouchableOpacity onPress={() => navigation.replace('Home')}style={{borderRadius: 15,justifyContent: 'flex-start',marginRight: 325,marginTop:-50}}>
              <AntDesign style={{ marginLeft: 3, marginTop: 2 }} name="arrowleft" size={24} color="black" />
          </TouchableOpacity>
    ...
    <View style={{marginTop: 20}}/>
          ...
          <TouchableOpacity onPress={() => loginUser(email, password)} style={{ width: 150, borderRadius: 50,borderColor: 'blue', backgroundColor: '#007FFF',marginLeft: 'auto', marginRight:'auto', padding: 10}}>
