...
const Register = ({navigation}) => {
  ...
  return (
        <ImageBackground source={image} resizeMode="cover" style={styles.bg}>
          <TouchableOpacity onPress={() => navigation.replace('Home')} style={{ borderRadius: 15, justifyContent: 'flex-start', marginRight: 325, marginTop: -40 }}>
        ...
        <Image style={{width: 200,height: 200, marginBottom: 30}} source={rimage}/>
          ...
          <TouchableOpacity 
              ...
              style={{ width: 150, borderRadius: 50, borderColor: 'blue', backgroundColor: '#007FFF', marginLeft: 'auto', marginRight: 'auto', padding: 10 }}>
